...
namespace Test2_WebDomParsers
{
    public partial class Form1 : Form
    {
        ...
        void LoadHtmlSamples(TreeView _samplesTreeView)
        {
...
#if DEBUG
            string checkFolder = "\\HtmlKit\\Test2_WebDomParsers\\bin\\Debug";
#else
            string checkFolder = "\\HtmlKit\\Test2_WebDomParsers\\bin\\Release";
#endif
            ...
            string rootSampleFolder = execFromFolder.Substring(0, index) + "\\HtmlKit\\Test2_WebDomParsers\\SampleData";
